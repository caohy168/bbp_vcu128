...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(gt_rxp_in, gt_rxn_in, gt_txp_out, gt_txn_out, 
  ...
  gtwiz_reset_rx_datapath_0, gt_loopback_in_0, rx_reset_0, user_rx_reset_0, 
  rx_axis_tvalid_0, rx_axis_tdata_0, rx_axis_tkeep_0, rx_axis_tuser_0, rx_axis_tlast_0, 
  ctl_rx_test_pattern_0, ctl_rx_enable_0, ctl_rx_delete_fcs_0, ctl_rx_ignore_fcs_0, 
  ctl_rx_max_packet_len_0, ctl_rx_min_packet_len_0, ctl_rx_check_sfd_0, 
  ctl_rx_check_preamble_0, ctl_rx_process_lfi_0, ctl_rx_force_resync_0, 
  stat_rx_block_lock_0, stat_rx_framing_err_valid_0_0, stat_rx_framing_err_0_0, 
  ...
  tx_unfout_0, ctl_tx_test_pattern_0, ctl_tx_enable_0, ctl_tx_fcs_ins_enable_0, 
  ctl_tx_send_lfi_0, ctl_tx_send_rfi_0, ctl_tx_send_idle_0, ctl_tx_ignore_fcs_0, 
