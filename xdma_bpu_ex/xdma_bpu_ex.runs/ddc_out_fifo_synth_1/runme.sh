...
HD_PWD='/home/caohy168/Work/bbp_vcu128/xdma_bpu_ex/xdma_bpu_ex.runs/ddc_out_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddc_out_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddc_out_fifo.tcl
