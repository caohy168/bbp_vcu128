...
HD_PWD='/home/caohy168/Work/bbp_vcu128/xdma_bpu_ex/xdma_bpu_ex.runs/bbp_mmc_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bbp_mmc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bbp_mmc.tcl
