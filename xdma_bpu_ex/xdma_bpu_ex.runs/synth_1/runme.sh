...
HD_PWD='/home/caohuiyang/Work/bbp_vcu128/xdma_bpu_ex/xdma_bpu_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log baseband_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source baseband_processor.tcl
