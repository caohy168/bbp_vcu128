...
HD_PWD='/home/caohy168/Work/bbp_vcu128/xdma_bpu_ex/xdma_bpu_ex.runs/sub_duc_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_duc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_duc.tcl
