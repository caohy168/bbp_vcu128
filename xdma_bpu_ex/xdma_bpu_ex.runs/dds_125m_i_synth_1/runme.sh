...
HD_PWD='/home/caohuiyang/Work/bbp_vcu128/xdma_bpu_ex/xdma_bpu_ex.runs/dds_125m_i_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_125m_i.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_125m_i.tcl
