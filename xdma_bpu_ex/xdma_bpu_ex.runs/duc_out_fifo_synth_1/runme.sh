...
HD_PWD='/home/caohy168/Work/bbp_vcu128/xdma_bpu_ex/xdma_bpu_ex.runs/duc_out_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log duc_out_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source duc_out_fifo.tcl
