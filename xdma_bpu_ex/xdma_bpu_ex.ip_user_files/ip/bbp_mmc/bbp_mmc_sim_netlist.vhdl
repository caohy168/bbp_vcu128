...
--               /home/caohy168/Work/bbp_vcu128/xdma_bpu_ex/xdma_bpu_ex.runs/bbp_mmc_synth_1/bbp_mmc_sim_netlist.vhdl
-- Design      : bbp_mmc
...
architecture STRUCTURE of bbp_mmc_clk_wiz is
...
entity bbp_mmc is
  ...
  attribute NotValidForBitStream of bbp_mmc : entity is true;
end bbp_mmc;

architecture STRUCTURE of bbp_mmc is
begin
inst: entity work.bbp_mmc_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
