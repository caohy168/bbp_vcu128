...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "apskmod.autotvin.dat"
	set constFileTvOut       "apskmod.autotvout.dat"
	set constFileHdlTvIn     "apskmod.autohdltvin.dat"
	set constFileHdlTvOut    "apskmod.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
