...
HD_PWD='/home/caohy168/Work/apsk_mdem/apskmod/apskmod/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log apskmod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source apskmod.tcl -notrace
