...
HD_PWD='/home/caohy168/Work/apsk_mdem/apskmod/apskmod/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log apskmod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apskmod.tcl
