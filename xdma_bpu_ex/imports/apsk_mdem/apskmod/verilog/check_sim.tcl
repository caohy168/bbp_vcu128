...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.apskmod.autotvin_mod_datin.dat"
         "c.apskmod.autotvin_modi.dat"
         "c.apskmod.autotvin_modq.dat"
         "c.apskmod.autotvout_modi.dat"
         "c.apskmod.autotvout_modq.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.apskmod.autotvout_modi.dat"
         "rtl.apskmod.autotvout_modq.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
