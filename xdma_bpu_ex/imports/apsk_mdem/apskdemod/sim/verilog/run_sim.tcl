...
if {[file isfile apskdemod.autotvin.dat]} {
	file delete -force apskdemod.autotvin.dat
}

if {[file isfile apskdemod.autotvout.dat]} {
	file delete -force apskdemod.autotvout.dat
}
