...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.apskdemod.autotvin_demod_datout.dat"
         "c.apskdemod.autotvin_demodi.dat"
         "c.apskdemod.autotvin_demodq.dat"
         "c.apskdemod.autotvout_demod_datout.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.apskdemod.autotvout_demod_datout.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
