...
// ==============================================================
# 1 "/home/caohy168/Work/bbp_vcu128/rs_codeco/rscode/rscode.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "/home/caohy168/Work/bbp_vcu128/rs_codeco/rscode/rscode.h" 1
# 11 "/home/caohy168/Work/bbp_vcu128/rs_codeco/rscode/rscode.h"
...
using std::tgamma;
using std::trunc;
# 12 "/home/caohy168/Work/bbp_vcu128/rs_codeco/rscode/rscode.h" 2
...
# 13 "/home/caohy168/Work/bbp_vcu128/rs_codeco/rscode/rscode.h" 2
...
# 14 "/home/caohy168/Work/bbp_vcu128/rs_codeco/rscode/rscode.h" 2
...
# 21 "/home/caohy168/Work/bbp_vcu128/rs_codeco/rscode/rscode.h"
void generate_gf(int alpha_out[255 +1],int index_out[255 +1]);
void gen_poly(int gg_out [255 -235 +1]);
void encode_rs(int data_in[235],int bb_out[255 -235],int recd_out [255],
         int alpha_to_out [255 +1],int index_of_out [255 +1],int gg_out [255 -235 +1]);
# 6 "/home/caohy168/Work/bbp_vcu128/rs_codeco/rscode/rscode.cpp" 2
...

{
 ...
 for(i=0; i<235; i++)
  data[i] = data_in[i];
 for (i=0; i<255 -235; i++) bb[i] = 0 ;
 for (i=235 -1; i>=0; i--)
    {

  feedback = index_of[data[i]^bb[255 -235 -1]] ;
  if(feedback != -1)
        {
   for (j=255 -235 -1; j>0; j--)
            if (gg[j] != -1)
 ...
 for (i=0; i<255 -235; i++) bb_out[i] = bb[i];


 for (i=0; i<255 -235; i++)
  recd_out[i] = bb[i] ;
 for (i=0; i<235; i++)
  recd_out[i+255 -235] = data_in[i] ;
...
extern "C"
#endif
void apatb_encode_rs_ir(int *, int *, int *, int *, int *, int *);
#ifdef __cplusplus
extern "C"
#endif
void encode_rs_hw_stub(int *data_in, int *bb_out, int *recd_out, int *alpha_to_out, int *index_of_out, int *gg_out){
encode_rs(data_in, bb_out, recd_out, alpha_to_out, index_of_out, gg_out);
return ;
}
#ifdef __cplusplus
extern "C"
#endif
void apatb_encode_rs_sw(int *data_in, int *bb_out, int *recd_out, int *alpha_to_out, int *index_of_out, int *gg_out){
apatb_encode_rs_ir(data_in, bb_out, recd_out, alpha_to_out, index_of_out, gg_out);
return ;
}
#endif
# 52 "/home/caohy168/Work/bbp_vcu128/rs_codeco/rscode/rscode.cpp"
