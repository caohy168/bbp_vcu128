...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "encode_rs.autotvin.dat"
	set constFileTvOut       "encode_rs.autotvout.dat"
	set constFileHdlTvIn     "encode_rs.autohdltvin.dat"
	set constFileHdlTvOut    "encode_rs.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
