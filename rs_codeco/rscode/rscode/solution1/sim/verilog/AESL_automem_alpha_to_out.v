...
module AESL_automem_alpha_to_out (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.encode_rs.autotvin_alpha_to_out.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.encode_rs.autotvout_alpha_to_out.dat"; 
//------------------------Local signal-------------------
