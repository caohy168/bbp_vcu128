...
module AESL_automem_index_of_out (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.encode_rs.autotvin_index_of_out.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.encode_rs.autotvout_index_of_out.dat"; 
//------------------------Local signal-------------------
