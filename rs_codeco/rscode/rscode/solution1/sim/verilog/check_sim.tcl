...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.encode_rs.autotvin_data_in.dat"
         "c.encode_rs.autotvin_bb_out.dat"
         "c.encode_rs.autotvin_recd_out.dat"
         "c.encode_rs.autotvin_alpha_to_out.dat"
         "c.encode_rs.autotvin_index_of_out.dat"
         "c.encode_rs.autotvin_gg_out.dat"
         "c.encode_rs.autotvout_bb_out.dat"
         "c.encode_rs.autotvout_recd_out.dat"
         "c.encode_rs.autotvout_alpha_to_out.dat"
         "c.encode_rs.autotvout_index_of_out.dat"
         "c.encode_rs.autotvout_gg_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.encode_rs.autotvout_bb_out.dat"
         "rtl.encode_rs.autotvout_recd_out.dat"
         "rtl.encode_rs.autotvout_alpha_to_out.dat"
         "rtl.encode_rs.autotvout_index_of_out.dat"
         "rtl.encode_rs.autotvout_gg_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
