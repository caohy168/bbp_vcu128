...
if {[file isfile encode_rs.autotvin.dat]} {
	file delete -force encode_rs.autotvin.dat
}

if {[file isfile encode_rs.autotvout.dat]} {
	file delete -force encode_rs.autotvout.dat
}
