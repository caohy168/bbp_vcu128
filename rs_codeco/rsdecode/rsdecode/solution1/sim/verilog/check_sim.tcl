...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.decode_rs.autotvin_recd_in.dat"
         "c.decode_rs.autotvin_recd_out.dat"
         "c.decode_rs.autotvin_recd_gf_out.dat"
         "c.decode_rs.autotvin_alpha_to_out.dat"
         "c.decode_rs.autotvin_index_of_out.dat"
         "c.decode_rs.autotvin_gg_out.dat"
         "c.decode_rs.autotvout_recd_out.dat"
         "c.decode_rs.autotvout_recd_gf_out.dat"
         "c.decode_rs.autotvout_alpha_to_out.dat"
         "c.decode_rs.autotvout_index_of_out.dat"
         "c.decode_rs.autotvout_gg_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.decode_rs.autotvout_recd_out.dat"
         "rtl.decode_rs.autotvout_recd_gf_out.dat"
         "rtl.decode_rs.autotvout_alpha_to_out.dat"
         "rtl.decode_rs.autotvout_index_of_out.dat"
         "rtl.decode_rs.autotvout_gg_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
