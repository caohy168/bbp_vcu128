...
module AESL_automem_recd_gf_out (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.decode_rs.autotvin_recd_gf_out.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.decode_rs.autotvout_recd_gf_out.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 8;
parameter DEPTH = 32'd 255;
parameter DLY = 0.1;
