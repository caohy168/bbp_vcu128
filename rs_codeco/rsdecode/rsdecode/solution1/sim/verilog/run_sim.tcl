...
if {[file isfile decode_rs.autotvin.dat]} {
	file delete -force decode_rs.autotvin.dat
}

if {[file isfile decode_rs.autotvout.dat]} {
	file delete -force decode_rs.autotvout.dat
}
