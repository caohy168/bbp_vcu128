...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "decode_rs.autotvin.dat"
	set constFileTvOut       "decode_rs.autotvout.dat"
	set constFileHdlTvIn     "decode_rs.autohdltvin.dat"
	set constFileHdlTvOut    "decode_rs.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
