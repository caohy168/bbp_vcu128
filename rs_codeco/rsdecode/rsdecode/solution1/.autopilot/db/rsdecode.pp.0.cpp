...
# 1 "./rsdecode.h" 1
# 11 "./rsdecode.h"
# 1 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/math.h" 1 3
# 36 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/math.h" 3
# 1 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 1 3
# 40 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 3
...
# 42 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 2 3
...
# 43 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 2 3
...
# 44 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 2 3
...
# 46 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 2 3
# 77 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 3
extern "C++"
{
namespace std __attribute__ ((__visibility__ ("default")))
{
...
# 435 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 3
  template<typename _Tp, typename _Up>
    inline constexpr
    typename __gnu_cxx::__promote_2<_Tp, _Up>::__type
    pow(_Tp __x, _Up __y)
...
# 559 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 3
namespace std __attribute__ ((__visibility__ ("default")))
{
...
# 957 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 3
}
# 1072 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 3
namespace std __attribute__ ((__visibility__ ("default")))
{
...
# 1797 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cmath" 3
}
# 37 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/math.h" 2 3
...
__attribute__((sdx_kernel("decode_rs", 0))) void decode_rs(int recd_in[255],int recd_out[255],int recd_gf_out[255], int syn_error_out,
...

{
 ...
 mask >>= 1;
 VITIS_LOOP_30_2: for (i=8 +1; i<255; i++)
 {
 ...
 index_of[0] = -1 ;
 VITIS_LOOP_39_3: for (i=0; i<255; i++)
...

{
 ...
 gg[0] = 2 ;
 gg[1] = 1 ;
 VITIS_LOOP_50_1: for (i=2; i<=255 -235; i++)
    {
  gg[i] = 1 ;
  VITIS_LOOP_53_2: for (j=i-1; j>0; j--)
   if (gg[j] != 0)
  ...
  gg[0] = alpha_to[(index_of[gg[0]]+i)%255] ;
   ...
   VITIS_LOOP_65_3: for (i=0; i<=255 -235; i++){
    gg[i] = index_of[gg[i]];}
   VITIS_LOOP_67_4: for (i=0; i<=255 -235; i++){
       gg_out[i]=gg[i];}
...
__attribute__((sdx_kernel("decode_rs", 0))) void decode_rs(int recd_in[255],int recd_out[255],int recd_gf_out[255], int syn_error_out,
  int alpha_to_out [255 +1],int index_of_out [255 +1],int gg_out [255 -235 +1])
{_ssdm_SpecArrayDimSize(recd_in, 255);_ssdm_SpecArrayDimSize(recd_out, 255);_ssdm_SpecArrayDimSize(recd_gf_out, 255);_ssdm_SpecArrayDimSize(alpha_to_out, 256);_ssdm_SpecArrayDimSize(index_of_out, 256);_ssdm_SpecArrayDimSize(gg_out, 21);
#pragma HLS INTERFACE axis register register_mode=both port=recd_in
# 76 "rsdecode.cpp"

#pragma HLS INTERFACE axis register register_mode=both port=recd_out
# 76 "rsdecode.cpp"

#pragma HLS TOP name=decode_rs
# 76 "rsdecode.cpp"
  ...
  VITIS_LOOP_85_1: for(i=0; i<255; i++)recd[i]=recd_in[i];

  VITIS_LOOP_87_2: for(i=0; i<255; i++)
   {if(recd[i] == -1)
    recd[i] = 0;
   else
    recd[i] = index_of[recd[i]];}
  VITIS_LOOP_92_3: for(i=0; i<255; i++) recd_gf_out[i]=recd[i];
  VITIS_LOOP_93_4: for (i=1; i<=255 -235; i++)
  {
   s[i] = 0 ;
   VITIS_LOOP_96_5: for (j=0; j<255; j++)
         if (recd[j]!=-1)
  ...
  if (syn_error)
   ...
   elp[0][0] = 0 ;
   elp[1][0] = 1 ;
   VITIS_LOOP_120_6: for (i=1; i<255 -235; i++)
         {
    elp[0][i] = -1 ;
    elp[1][i] = 0 ;
         }
   ...
   VITIS_LOOP_130_7: do
   {
    ...
    {
     l[u+1] = l[u] ;
     VITIS_LOOP_136_8: for (i=0; i<=l[u]; i++)
     {
      elp[u+1][i] = elp[u][i] ;
    ...
    {
     q = u-1 ;
     VITIS_LOOP_146_9: while ((d[q]==-1) && (q>0))
      q-- ;

     if (q>0)
     {
      j=q ;
     VITIS_LOOP_152_10: do
     {
      j-- ;
     ...
     l[u+1] = l[q]+u-q ;
             ...
             VITIS_LOOP_166_11: for (i=0; i<255 -235; i++)
     elp[u+1][i] = 0 ;
             VITIS_LOOP_168_12: for (i=0; i<=l[q]; i++)
     if (elp[q][i]!=-1)
      elp[u+1][i+u-q] = alpha_to[(d[u]+255 -d[q]+elp[q][i])%255] ;
             VITIS_LOOP_171_13: for (i=0; i<=l[u]; i++)
               {
       elp[u+1][i] ^= elp[u][i] ;
                 elp[u][i] = index_of[elp[u][i]] ;
               }
         ...
         if (u<255 -235)
   {
    if (s[u+1]!=-1)
     ...
     d[u+1] = 0 ;
             VITIS_LOOP_185_14: for (i=1; i<=l[u+1]; i++)
  ...
  if (l[u]<=10)
  {
   ...
   VITIS_LOOP_195_15: for (i=0; i<=l[u]; i++)
    elp[u][i] = index_of[elp[u][i]] ;


   VITIS_LOOP_199_16: for (i=1; i<=l[u]; i++)
    reg[i] = elp[u][i] ;
   count = 0 ;
   VITIS_LOOP_202_17: for (i=1; i<=255; i++)
   {
    q = 1 ;
    VITIS_LOOP_205_18: for (j=1; j<=l[u]; j++)
    if (reg[j]!=-1)
    {
     reg[j] = (reg[j]+j)%255 ;
     q ^= alpha_to[reg[j]] ;
   ...
   if (count==l[u])
   {
    VITIS_LOOP_221_19: for (i=1; i<=l[u]; i++)
             {
     if ((s[i]!=-1) && (elp[u][i]!=-1))
      ...
      z[i] = 0 ;
     VITIS_LOOP_231_20: for (j=1; j<i; j++)
    ...
    VITIS_LOOP_238_21: for (i=0; i<255; i++)
    {
     err[i] = 0 ;
     if (recd[i]!=-1)
    ...
    VITIS_LOOP_246_22: for (i=0; i<l[u]; i++)
             {
     err[loc[i]] = 1;
     VITIS_LOOP_249_23: for (j=1; j<=l[u]; j++)
      if (z[j]!=-1)
     ...
     if (err[loc[i]]!=0)
     {
      ...
      q = 0 ;
      VITIS_LOOP_256_24: for (j=0; j<l[u]; j++)
      if (j!=i)
   ...
   {
    VITIS_LOOP_267_25: for (i=0; i<255; i++)
     if (recd[i]!=-1)
      recd[i] = alpha_to[recd[i]] ;
     else
      recd[i] = 0 ;
   ...
   {
    VITIS_LOOP_276_26: for (i=0; i<255; i++)
     if (recd[i]!=-1)
      recd[i] = alpha_to[recd[i]] ;
     else
      recd[i] = 0 ;
   ...
   VITIS_LOOP_284_27: for (i=0; i<255; i++)
   {
    if (recd[i]!=-1)
     recd[i] = alpha_to[recd[i]] ;
    else
 ...
 VITIS_LOOP_293_28: for (i=0; i<255; i++)recd_out[i] = recd[i];
