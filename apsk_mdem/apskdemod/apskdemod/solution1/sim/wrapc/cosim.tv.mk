...
$(ObjDir)/apskdemod_inspire.cpp_pre.cpp.tb.o : apskdemod_inspire.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling apskdemod_inspire.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/apskdemod.cpp_pre.cpp.tb.o : apskdemod.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling apskdemod.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
