...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "apskdemod.autotvin.dat"
	set constFileTvOut       "apskdemod.autotvout.dat"
	set constFileHdlTvIn     "apskdemod.autohdltvin.dat"
	set constFileHdlTvOut    "apskdemod.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
