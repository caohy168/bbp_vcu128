...
# 1 "./apskdemod.h" 1
# 12 "./apskdemod.h"
__attribute__((sdx_kernel("apskdemod", 0))) void apskdemod(int demod_datout[340],
...
__attribute__((sdx_kernel("apskdemod", 0))) void apskdemod(int demod_datout[340],float demodi[340],float demodq[340]) {_ssdm_SpecArrayDimSize(demod_datout, 340);_ssdm_SpecArrayDimSize(demodi, 340);_ssdm_SpecArrayDimSize(demodq, 340);
#pragma HLS INTERFACE axis register register_mode=both port=demod_datout
# 12 "apskdemod.cpp"

#pragma HLS INTERFACE axis register register_mode=both port=demodi
# 12 "apskdemod.cpp"

#pragma HLS INTERFACE axis register register_mode=both port=demodq
# 12 "apskdemod.cpp"

#pragma HLS TOP name=apskdemod
# 12 "apskdemod.cpp"
 ...
 VITIS_LOOP_20_1: for( int i = 0; i <340 ; i = i + 1 )demod_tempout[i]=0,demod_del[i]=0;
 VITIS_LOOP_21_2: for( int i = 0; i <340 ; i = i + 1 )demod_tempouti[i]=demodi[i];
 VITIS_LOOP_22_3: for( int i = 0; i <340 ; i = i + 1 )demod_tempoutq[i]=demodq[i];
 VITIS_LOOP_23_4: for( int i = 0; i <340 ; i = i + 1 ){
...
# 346 "apskdemod.cpp"
 VITIS_LOOP_346_5: for( int k = 0; k <340 ; k = k + 1 ){
# 355 "apskdemod.cpp"
