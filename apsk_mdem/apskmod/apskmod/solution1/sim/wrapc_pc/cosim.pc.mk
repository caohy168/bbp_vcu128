...
$(ObjDir)/apskmod_inspire.cpp_pre.cpp.tb.o : apskmod_inspire.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling apskmod_inspire.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/apskmod.cpp_pre.cpp.tb.o : apskmod.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling apskmod.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
