; ModuleID = '/home/caohy168/Work/bbp_vcu128/apsk_mdem/apskmod/apskmod/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define void @apatb_apskmod_ir(i32* %mod_datin, float* %modi, float* %modq) local_unnamed_addr #0 {
entry:
  %mod_datin_copy = alloca [340 x i32], align 512
  %modi_copy = alloca [340 x float], align 512
  %modq_copy = alloca [340 x float], align 512
  %0 = bitcast i32* %mod_datin to [340 x i32]*
  %1 = bitcast float* %modi to [340 x float]*
  %2 = bitcast float* %modq to [340 x float]*
  call fastcc void @copy_in([340 x i32]* %0, [340 x i32]* nonnull align 512 %mod_datin_copy, [340 x float]* %1, [340 x float]* nonnull align 512 %modi_copy, [340 x float]* %2, [340 x float]* nonnull align 512 %modq_copy)
  %3 = getelementptr inbounds [340 x i32], [340 x i32]* %mod_datin_copy, i32 0, i32 0
  ...
  call void @apatb_apskmod_hw(i32* %3, float* %4, float* %5)
  call fastcc void @copy_out([340 x i32]* %0, [340 x i32]* nonnull align 512 %mod_datin_copy, [340 x float]* %1, [340 x float]* nonnull align 512 %modi_copy, [340 x float]* %2, [340 x float]* nonnull align 512 %modq_copy)
  ret void
}
...
declare void @apatb_apskmod_hw(i32*, float*, float*)

define void @apskmod_hw_stub_wrapper(i32*, float*, float*) #5 {
entry:
