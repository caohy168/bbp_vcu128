...
# 1 "./apskmod.h" 1
# 10 "./apskmod.h"
__attribute__((sdx_kernel("apskmod", 0))) void apskmod(int mod_datin[340],float modi[340],float modq[340]);
# 9 "apskmod.cpp" 2
...
__attribute__((sdx_kernel("apskmod", 0))) void apskmod(int mod_datin[340],float modi[340],float modq[340]) {_ssdm_SpecArrayDimSize(mod_datin, 340);_ssdm_SpecArrayDimSize(modi, 340);_ssdm_SpecArrayDimSize(modq, 340);
#pragma HLS INTERFACE axis register register_mode=both port=mod_datin
# 12 "apskmod.cpp"

#pragma HLS INTERFACE axis register register_mode=both port=modi
# 12 "apskmod.cpp"

#pragma HLS INTERFACE axis register register_mode=both port=modq
# 12 "apskmod.cpp"

#pragma HLS TOP name=apskmod
# 12 "apskmod.cpp"

 int mod_tempin[340];
 float mod_tempouti[340];
 float mod_tempoutq[340];
 apskmod_label0:for( int i = 0; i <340 ; i = i + 1 )
#pragma HLS PIPELINE
# 16 "apskmod.cpp"
mod_tempin[i]=mod_datin[i];
